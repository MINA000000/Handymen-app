...
class _ClientProfileState extends State<ClientProfile> {
  ...
  Future<void> getClientData()async{
    DocumentSnapshot documentSnapshot =await FirebaseFirestore.instance.collection(CollectionsNames.clientsInformation).doc(FirebaseAuth.instance.currentUser!.uid).get();
